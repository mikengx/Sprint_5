...
from locators import LOGIN_BUTTON_HEADER, NO_ACCOUNT_BUTTON, EMAIL_INPUT, \
    CREATE_ACCOUNT_BUTTON, EMAIL_BORDER, PWD_1_BORDER, \
    PWD_2_BORDER, ERROR_TEXT_LOGIN
from urls import BASE_URL
from utils import generate_incorrect_email
from data import ERROR_BORDER_COLOR, ERROR_TEXT_STRING


def test_user_register_with_incorrect_email_shows_error(driver): # 2
